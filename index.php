   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
        ...
        <div class="slide">
            ...
            <div class="content">
               <h3>Simplified Delivery Options</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
               <div class="fas fa-angle-right" onclick="next()"></div>
            </div>
         </div>
...
<section class="about" id="about">
   ...
   <div class="box-container">
     ...
     <div class="box">
         ...
         <h3>Simplify Ordering</h3>
         <p>Our system eliminates the need for manual order processing, saving you time and reducing the risk of errors.</p>
     ...
     <div class="box">
         ...
         <h3>Centralized Management</h3>
         <p>Easily manage orders, track inventory, and approve or deny requests from a single dashboard.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
 ...
 <div class="box">
         ...
         <p>Gain real-time insights into order status, inventory levels, menus and spending patterns.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <div class="accordion-container">
     ...
     <div class="accordion active">
         <div class="accordion-heading">
            <span>What is the purpose of an order management system?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
           An order management system is a software application that helps businesses streamline the process of ordering supplies and other items.
         </p>
      </div>

       <div class="accordion">
         <div class="accordion-heading">
            <span>What are the benefits of using an order management system?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
          There are many benefits to using an order management system. Some of the most common benefits include:Reduced ordering costs,Improved inventory management,Increased efficiency,Improved accuracy.
         </p>
      </div>

           <div class="accordion">
         <div class="accordion-heading">
            <span>What are some of the features of an order management system?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            Some of the common features of an order management system include:Online ordering,Inventory tracking,Reporting,Approval workflow,Budget tracking.
         </p>
      </div>

     <div class="accordion">
         <div class="accordion-heading">
            <span>How do I choose an order management system for my business?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            When choosing an order management system, it is important to consider the following factors:The size of your business,Your budget,Your specific needs,Your ease of use.
         </p>
      </div>
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>How does an OMS help businesses improve their order fulfillment process?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
            An OMS automates tasks, optimizes inventory, integrates systems, and provides insights to improve order fulfillment.
         </p>
      </div>
...
<section class="footer">
   ...
   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>Avanti_Joshi</span> | all rights reserved!
   </div>
